...
var _a;
const $$Miniproduct = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "\u30DF\u30CB\u30D7\u30ED\u30C0\u30AF\u30C8\u8A2D\u8A08\u56F3\u96C6 - \u53E1\u667A\u306E\u5B9D\u7269\u5EAB" }, { "default": async ($$result2) => renderTemplate(_a || (_a = __template([" ", '<div class="content-wrapper"> <h1 class="page-title mb-2">\u30DF\u30CB\u30D7\u30ED\u30C0\u30AF\u30C8\u8A2D\u8A08\u56F3\u96C6</h1> <p class="text-xl text-gray-400 mb-12">\u3053\u3053\u306F\u3001\u30B7\u30F3\u30D7\u30EB\u306A\u8A2D\u8A08\u66F8\u3084\u6307\u5357\u66F8\u3092\u4F5C\u6210\u3059\u308B\u30D7\u30ED\u30F3\u30D7\u30C8\u3092\u53CE\u5BB9\u3057\u3066\u3044\u307E\u3059\u3002\u65B0\u3057\u3044\u8996\u70B9\u304C\u624B\u306B\u5165\u308B\u30CF\u30BA\u3067\u3059\u3002\u8133\u306E\u30A2\u30C3\u30D7\u30B0\u30EC\u30FC\u30C9\u306B\u3082\u306A\u308A\u307E\u3059\u3002</p> ', ' <div class="card-grid"> ', ` </div> </div> <script>
...
<\/script> `], [" ", '<div class="content-wrapper"> <h1 class="page-title mb-2">\u30DF\u30CB\u30D7\u30ED\u30C0\u30AF\u30C8\u8A2D\u8A08\u56F3\u96C6</h1> <p class="text-xl text-gray-400 mb-12">\u3053\u3053\u306F\u3001\u30B7\u30F3\u30D7\u30EB\u306A\u8A2D\u8A08\u66F8\u3084\u6307\u5357\u66F8\u3092\u4F5C\u6210\u3059\u308B\u30D7\u30ED\u30F3\u30D7\u30C8\u3092\u53CE\u5BB9\u3057\u3066\u3044\u307E\u3059\u3002\u65B0\u3057\u3044\u8996\u70B9\u304C\u624B\u306B\u5165\u308B\u30CF\u30BA\u3067\u3059\u3002\u8133\u306E\u30A2\u30C3\u30D7\u30B0\u30EC\u30FC\u30C9\u306B\u3082\u306A\u308A\u307E\u3059\u3002</p> ', ' <div class="card-grid"> ', ` </div> </div> <script>
document.addEventListener('DOMContentLoaded', () => {
    // --- \u3053\u306E\u30DA\u30FC\u30B8\u306B\u5B58\u5728\u3059\u308B\u3001\u5168\u3066\u306E\u9B42\u306E\u5668\u3092\u53EC\u559A ---
    const allCards = document.querySelectorAll('.treasure-card');
    const modalOverlay = document.getElementById('modal-overlay');
...
}, "C:/Users/USER/a1-body/src/pages/treasury/miniproduct.astro", void 0);

const $$file = "C:/Users/USER/a1-body/src/pages/treasury/miniproduct.astro";
const $$url = "/treasury/miniproduct";
